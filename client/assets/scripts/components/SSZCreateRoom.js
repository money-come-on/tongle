cc.Class({
    ...
    initSlider:function(){
        ...
        if(slider) {
            ...
            cc.module.utils.addSlideEvent(slider,this.node,"SSZCreateRoom","onWealthSlider");
        }
        ...
        if(gameTimeSlider){
            cc.module.utils.addSlideEvent(gameTimeSlider,this.node,"SSZCreateRoom","ongameTimeSlider");
        }
        var lipaiTimeSlider = this.lipaiTiemItem.getChildByName("slider");
        this._lipaiTimeSlider = lipaiTimeSlider;
        if(lipaiTimeSlider){
            cc.module.utils.addSlideEvent(lipaiTimeSlider,this.node,"SSZCreateRoom","onlipaiTimeSlider");
        }
        var controlSlider = this.controlItem.getChildByName("slider");
        this._controlSlider = controlSlider;
        if(controlSlider){
            cc.module.utils.addSlideEvent(controlSlider,this.node,"SSZCreateRoom","oncontrolSlider");
        }
    },
